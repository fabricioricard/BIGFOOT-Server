...
// ========================
// HELPER: validação de bigAddress
// ========================
function isValidBigAddress(address) {
  return typeof address === 'string' && address.startsWith('big') && address.length >= 31;
}
...
app.post('/bridge/convert', verifyFirebaseToken, async (req, res) => {
  ...
  if (!isValidBigAddress(bigAddress)) {
